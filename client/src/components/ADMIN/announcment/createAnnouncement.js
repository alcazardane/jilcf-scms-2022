...
const CreateAnnouncement = ({ refreshAnnounceTable }) => {
    ...
    const handleCreateAnnounce = async (e) => {
        ...
        try {
        const res = await fetch('http://localhost:5000/api/announcements/create-announcement', {
            method: 'POST',
    ...
    return (
        <>
            <form className="adminModule_create_account_con" onSubmit={handleCreateAnnounce}>
                <div className="editAtt_Modal_label-b">Create Announcement</div>
                ...
                <button className="editAtt_update_button" onClick={handleCreateAnnounce}>Add</button>
            </form>
        </>
    )
}
