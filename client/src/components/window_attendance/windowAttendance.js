...
//======================================================================================================================
    ...
    useEffect(() => {
        ...
        if (multiID?.length > 0){
            root.style.setProperty('--viewStudent_edit_multiRecord-opacity', "1");
            root.style.setProperty('--viewStudent_edit_multiRecord-pointer-events', "all");
            root.style.setProperty('--viewStudent_multiEdit_warning-opacity', "0");
        }
        else{
            root.style.setProperty('--viewStudent_edit_multiRecord-opacity', "0.5");
            root.style.setProperty('--viewStudent_edit_multiRecord-pointer-events', "none");
            root.style.setProperty('--viewStudent_multiEdit_warning-opacity', "1");
        }
    }, [multiID])
        ...
        <div className="windowAttendance_view_wrap">
            <div className="winAtt_viewStudent_wrap">
                ...
                <div className="winAtt_viewStudent_top_wrap">
                    <div className="winAtt_viewStudent_profile_wrap">
                        ...
                        <div className="winAtt_viewStudent_info_wrap">
                            ...
                            <select className="winAtt_viewStudent_sortCB" onChange={e => {setStudentAttQuery(e.target.value); sortDate(e.target.value)}}>
                                <option value="">Default</option>
                                <option value="e">Date Ascending</option>
                                <option value="s">Date Descending</option>
                ...
                <div className="winAtt_viewStudent_bottom_wrap">
                    <div className="winAtt_viewStudent_bottom_warning">*Select an item first</div>
                    <div className="winAtt_viewStudent_bottom_wrap">
                        <button 
