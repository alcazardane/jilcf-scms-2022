...
const Navbar_L3 = ({openAboutModule, openNotesModule}) => {
  ...
  return (
    ...
    <div ref={menuListRef} className={"menulist " + (menuIsOpen ? "openMenuList" : "closeMenuList")}>
        ...
        <div className="menulist_item_wrap" onClick={openNotesModule}>
            <button className="menulist_item"></button>
            <span className="menulist_item_label">Notes</span>
        </div>
        <div className="menulist_item_wrap" onClick={openAboutModule}>
            <button className="menulist_item"></button>
