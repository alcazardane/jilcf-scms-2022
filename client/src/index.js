...
import {Loginfunc, HomeL1, HomeL2, HomeL3, CreateUser, App, AssessmentWindow, AttendanceWindow, CalendarWindow, NotesWindow} from "./App";
    ...
    <Router>
      ...
      <Routes>
        <Route path="/" element={ <App /> }>
          ...
          <Route path="/home/notes" element={<NotesWindow/>}/>
        </Route>
      </Routes>
